<template>
  <main>
    ...
    <div style="display:flex; align-items: center;">
      ...
      <button @click="previousMonth" class="prev-month"><</button>
      <button @click="nextMonth" class="next-month">></button>
    </div>
      <div class="dates-container">
        <date-thumbnail v-for="i in days" :key="i" :day="i" :events="eventsOfMonth[i]" @click="$router.push(`/events/date/${year}-${month}-${i}`)" />
      </div>
  </main>
</template>

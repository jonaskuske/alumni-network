...
export default [
  {
    ...
    comments: [
      { gallery: [], content: "Super, freu mich drauf!", username: "jonaskuske" },
      { gallery: [], content: "Das mittlere sieht cool aus! Bin gespannt ob ich in die Top 10 gekommen bin. Hab ja versucht mal etwas anderes zu machen, aber das kann auch nach hinten losgehen... Außerdem rede ich jetzt noch ganz viel mehr damit mehrere Zeilen Text entstehen. :)", username: "matthiaswengel" },
      { gallery: [Plakat1, Plakat2], content: "Zwar zu spät für den Wettbewerb, aber hab auch rumprobiert, was meint ihr?", username: "sarahtau" },
      { gallery: [], content: "Sieht gut aus! Hättest Chancen gehabt, wärst du schneller gewesen 😜", username: "jonaskuske" }
    ],
  ...
  },
  {
    ...
    comments: [
      { username: "sarahtau", content: "Die hier ist soooooo süß...", gallery: [catWhite] },
      { username: "axelschmaxel", content: "Da kann ich locker mithalten :P", gallery: [catBowl, catSmirk] },
